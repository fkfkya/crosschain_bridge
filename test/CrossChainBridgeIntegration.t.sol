...
contract CrossChainBridgeIntegrationTest is Test {
    ...
    function setUp() public {
        ...
        bridgeA = new CrossChainBridge(address(tokenA), validator, MIN_AMOUNT, MAX_AMOUNT, FEE_BASIS_POINTS);

        bridgeB = new CrossChainBridge(address(tokenB), validator, MIN_AMOUNT, MAX_AMOUNT, FEE_BASIS_POINTS);
