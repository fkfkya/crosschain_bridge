...
contract DeployTokenScript is Script {
    function run() external {
        ...
        console.log(
            "2. To mint tokens: cast send <token_address> 'mint(address,uint256)' <recipient> <amount> --private-key <your_key>"
        );
        console.log(
            "3. To burn tokens: cast send <token_address> 'burn(address,uint256)' <from> <amount> --private-key <your_key>"
        );
    }
}
